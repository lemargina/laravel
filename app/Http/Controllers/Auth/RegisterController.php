...
class RegisterController extends Controller
{
   ...
   public function register(Request $request){
   	...
   	if($validator->passes()){
   		...
   		return redirect()->to('login')->with('success', "We sent confirmation code");
   	}
   ...
   public  function userActivation($token){
   	$check = DB::table('users_actiovations')->where('token',$token)->first();
   	if(is_null($check)){
   	...
   	return redirect()->to('login')->with('Sucess','User active succesfully');
   	}
